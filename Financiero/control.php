...
// mysqli
$mysqli = new mysqli("dannyasdcom.ipagemysql.com", "dannyasd", "dannyasd", "impresiones");
/* check connection */
...
if ($fila['id_tipo_usuario']=='Gerente') {
	...
	header("location: /impresiones/vertodas.php");
...
if ($fila['id_tipo_usuario']=="Contador") {
	...
	header("location: /impresiones/login/index.php?error=verdadero1");
}
