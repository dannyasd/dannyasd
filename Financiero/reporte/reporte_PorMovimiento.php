...
<body>
<img  width="200px" src="../imagenes/logo.png">  <h1><b>Reporte de Movimiento</b></h1>
<br>
<div align="center">
    <table width="95%" border="1">
      <tr>
        <td bgcolor="#0099FF"><strong>id_movimiento</strong></td>
        <td bgcolor="#0099FF"><strong>concepto</strong></td>
        <td bgcolor="#0099FF"><strong>Tipo de cuenta</strong></td>
        ...
        $consulta=mysql_query("SELECT * FROM `movimiento` WHERE `id_movimiento` = '".$_GET['id_movimiento']."' ");
...
$dompdf->render();
$dompdf->stream("Reporte_Activo.pdf");
?>