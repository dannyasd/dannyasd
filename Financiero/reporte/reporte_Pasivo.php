...
<body>
<img  width="200px" src="../imagenes/logo.png">  <h1><b>Reporte de de cuentas Pasivo</b></h1>
<br>
<div align="center">
    <table width="95%" border="1">
      <tr>
        ...
        $consulta=mysql_query("SELECT * FROM  `cuenta` WHERE cuenta.tipo_cuenta =  'Pasivo' ");
...
$dompdf->render();
$dompdf->stream("Reporte_Pasivo.pdf");
?>