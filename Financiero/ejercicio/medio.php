...
<center><form action="#" method="post">
    ...
    <input name='submit' type='submit' value='Buscar' id="gobutton">
</form></center>
<?php 
...
echo "<td><b></b></td>";
echo "<td><b></b></td>";
echo "<td><b><a class=\"modalbox small-button  modal\" href=\"/Financiero/reporte/reporte_Ejercicio.php\"><span>Reporte PDF</span></a></td>";
echo "<td><b><a class=\"modalbox small-button  modal\" href=\"/Financiero/ReporteDeEjercicios/samples/grafica.php\"><span>Ver Grafica</span></a></td></tr>";
...
echo "</tr>";
    ...
    echo "<td class=\"action\"><a  class=\"modalbox small-button modal\" href=\"/Financiero/movimiento/agregar_med.php?id_ejercicio=".$row["id_ejercicio"]."\"><span>Elegir</span></a></td>";
                echo "<td class=\"action\"><a  class=\"modalbox small-button modal\" href=\"agregar_med.php?id_ejercicio=".$row["id_ejercicio"]."\"><span>Editar</span></a></td>";
                echo "<td class=\"action\"><a class=\"modalbox small-button danger modal\" href=\"borrar_med.php?del=".$row["id_ejercicio"]."\"><span>Borrar</span></a></td>";
