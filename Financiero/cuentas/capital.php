...
/////////////////////////////////////////////////////
 ...
 $query = "select distinct SQL_CALC_FOUND_ROWS id_cuenta, tipo_cuenta, nombre_cuenta, descripcion from conta2.cuenta where tipo_cuenta= 'Capital' and nombre_cuenta like '%$var1%' LIMIT $offset, $limit"; 
//////////////////////////////////////////////////
...
echo "<td><b><a class=\"modalbox small-button  modal\" href=\"/Financiero/reporte/reporte_Capital.php\"><span>Reporte PDF</span></a></td>";
